<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AltaCursadas.aspx.cs" Inherits="CuotaSystem.Cursadas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-primary" id="form">
        <div class="panel-heading">
            <h2 class="panel-title">Alta Cursada</h2>
        </div>
        ...
        <div class="form-group">
            ...
            <div id="alerta" runat="server" visible="false" class="col-lg-4">
                <div class="alert alert-dismissable alert-success">
                    ...
                    <strong>La cursada se creó correctamente.</strong>
                </div>
            </div>
        </div>
    </div>
