<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditarInscripcion.aspx.cs" Inherits="CuotaSystem.EditarInscripcion" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-primary" id="form">
        <div class="panel-heading">
            <h2 class="panel-title">Modificar Inscripción</h2>
        </div>
        ...
        <div class="form-group">
            ...
            <b>
                <asp:Label ID="lblInscripcionAnulada" runat="server" Text="Inscripción Anulada" for="inscripcionAnulada" class="col-sm-2 control-label">      
                </asp:Label></b>
            <div class="col-sm-3">
                <label for="activo" class="checkbox inline">
                    <input id="inscripcionAnulada" type="checkbox" value="inscripcionAnulada" runat="server" />
                    <p>Tildar la casilla en caso de querer anular la inscripción.</p>
                </label>
