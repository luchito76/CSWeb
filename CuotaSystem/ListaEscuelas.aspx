<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ListaEscuelas.aspx.cs" Inherits="CuotaSystem.ListaEscuelas" %>
 ...
 <div class="panel panel-primary" id="form">
        ...
        <div class="bs-example table-responsive" id="page-selection">
            <asp:GridView ID="gdvListaEscuelas" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="false"
                ...
                PageSize="10" OnSelectedIndexChanging="gdvListaEscuelas_SelectedIndexChanging" OnPageIndexChanging="gdvListaEscuelas_PageIndexChanging">
                <Columns>
