<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Probando.aspx.cs" Inherits="CuotaSystem.Probando" %>
    ...
    <div class="panel panel-primary" id="form">
        ...
        <div class="bs-example table-responsive">
            ...
            <asp:GridView ID="gdvListaCursos" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="false"
                ...
                PageSize="7" OnSelectedIndexChanging="gdvListaCursos_SelectedIndexChanging" OnPageIndexChanging="gdvListaCursos_PageIndexChanging">
                <Columns>
